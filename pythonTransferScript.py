...
# destinationDirectory = str(input("Enter the destination directory (do not add a forward slash / at the end): "))
...
#     os.system('cp ' + file + ' ' + destinationDirectory)
#     print('moved ' + file)

# # move all of the files within each FOLDER in the folderList to the destination directory
# for folder in folderList:
#     os.system('cp -r ' + currentWD + '/' + folder + '/* ' + destinationDirectory + '/' + folder)
#     print('moved ' + folder)
